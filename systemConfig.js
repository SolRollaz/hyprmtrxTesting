    ...
    initializeNetworks() {
        return {
            ETH: {
                ...
                paymentWallet: process.env.PAYMENT_WALLET_ETH,
            },
            BNB: {
                ...
                paymentWallet: process.env.PAYMENT_WALLET_BNB,
            },
            AVAX: {
                name: "Avalanche",
                ...
                paymentWallet: process.env.PAYMENT_WALLET_AVAX,
            },
            BASE: {
                name: "Base",
                ...
                paymentWallet: process.env.PAYMENT_WALLET_BASE,
            },
            DAG: {
                ...
                paymentWallet: process.env.PAYMENT_WALLET_DAG,
            },
        };
    }
